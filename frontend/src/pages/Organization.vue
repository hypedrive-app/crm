<template>
  ...
  <div v-if="organization.doc" ref="parentRef" class="flex h-full">
    ...
    <Tabs
      ...
      as="div"
      :tabs="tabs"
      class="flex flex-1 overflow-hidden flex-col [&_[role='tablist']]:gap-7.5 [&_[role='tablist']]:px-5 [&_[role='tablist']]:[scrollbar-width:none] [&_[role='tablist']]:[-ms-overflow-style:none] [&_[role='tablist']::-webkit-scrollbar]:hidden [&_[role='tablist']]:min-h-[45px] [&_[role='tabpanel']:not([hidden])]:flex [&_[role='tabpanel']:not([hidden])]:grow"
    >
...
import EnrichMore from '@/components/EnrichMore.vue'
